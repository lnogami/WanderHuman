...
class MyFirebaseServices {
  ...
  // }) async {
  //   try {
  //     await _personalInfoCollectionReference.doc(userID).update({
  //       'profilePictureURL': base64Image,
  //     });
  //     print("✅ Profile picture updated successfully for userID: $userID");
  //   } catch (e) {
  //     print("❌ Error updating profile picture for userID $userID: $e");
  //     throw Exception();
  //   }
  // }
}
