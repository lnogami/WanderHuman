...
void bottomModalSheet(BuildContext context) {
  // first container
  double firstContainerDistanceFromTheTop = 80;
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              right: 20,
              child: CircleAvatar(
                // this will occupy 15% of the screen width
                radius: MyDimensionAdapter.getWidth(context) * 0.15,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    shortTextLayouter(constText: "Age", dynamicText: "{25}"),
                    shortTextLayouter(
                      constText: "Gender",
                      dynamicText: "{Female}",
                    ),
